...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    deleteProductWarning: 'Are you sure you want to delete',
  ...
  ne: {
    ...
    deleting: 'मेटाउँदै...',
    stockUpdated: 'स्टक सफलतापूर्वक अपडेट भयो',
    productDeleted: 'उत्पादन सफलतापूर्वक मेटाइयो',
    deleteProductConfirm: 'उत्पादन मेटाउने?',
    deleteProductWarning: 'के तपाईं मेटाउन निश्चित हुनुहुन्छ',
    actionCannotBeUndone: 'यो कार्य पूर्ववत गर्न सकिँदैन।',
